...
public class StatusActivity extends AppCompatActivity {
    ...
    //bring in user data from FirebaseDB
    FirebaseDatabase mDatabase;
    DatabaseReference mUsers;

    //track the username of each user
    private String mUsername;

    List<ChatStatus> allStatuses;
        ...
        mUsers.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot child: dataSnapshot.getChildren()) {
                    ...
                    ChatStatus userStatus = new ChatStatus(username, status, statusText);
                    chatStatuses.add(userStatus);
                }

                statusAdapter.replaceList(chatStatuses);
